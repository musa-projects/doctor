            ...
            <StaggerItem key={stat.key}>
              <div className="card-luxury p-6 md:p-8 text-center group">
                ...
                <div className="relative w-16 h-16 mx-auto mb-5">
                  <ProgressRing delay={index * 0.2} color={stat.ringColor} />
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-10 h-10 rounded-full bg-gold/10 flex items-center justify-center group-hover:bg-gold/20 transition-colors duration-500">
