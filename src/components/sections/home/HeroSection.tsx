...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className={`absolute inset-0 ${isLight ? "bg-gradient-to-b from-white/10 via-transparent to-white/20" : "bg-gradient-to-b from-background/60 via-background/40 to-background/80"}`} />
