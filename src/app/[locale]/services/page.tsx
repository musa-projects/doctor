                  ...
                  >
                    ...
                    <div className="relative h-48 overflow-hidden">
                      ...
                      <div className="absolute bottom-4 start-6">
                        <div className="w-12 h-12 rounded-lg backdrop-blur-sm flex items-center justify-center border bg-gold/20 border-gold/20">
                    ...
                    <div className="p-6">
                      <h2 className="text-xl font-semibold font-serif mb-3 transition-colors duration-300 group-hover:text-gold">
