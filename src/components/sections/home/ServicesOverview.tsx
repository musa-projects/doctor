  ...
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse at 80% 50%, rgba(201,168,76,0.02) 0%, transparent 50%)",
        }}
        aria-hidden="true"
      />
            ...
            return (
              <StaggerItem key={service.slug}>
                ...
                >
                  ...
                  {/* Title */}
                  <h3 className="text-xl font-semibold font-serif mb-3 group-hover:text-gold transition-colors duration-300">
